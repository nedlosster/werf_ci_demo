...
| [delivery/](delivery/README.md) | Поставка через kube_ci, секреты, версии | [dev-prod.md](delivery/dev-prod.md), [kube-ci-operations.md](delivery/kube-ci-operations.md), [secrets.md](delivery/secrets.md), [versioning.md](delivery/versioning.md), [dev-in-cluster.md](delivery/dev-in-cluster.md), [dev-caches-and-volumes.md](delivery/dev-caches-and-volumes.md), [dev-workflow-cycle.md](delivery/dev-workflow-cycle.md), [dev-in-cluster-vs-tools.md](delivery/dev-in-cluster-vs-tools.md) |
...
- [diagrams/](diagrams/) -- источники диаграмм в формате `.mmd`: `architecture`
  ...
  `product-anatomy`, `dora-flow`, `deploy-topology`, `dev-workflow-cycle`.
